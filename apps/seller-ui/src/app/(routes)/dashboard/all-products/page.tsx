...
import { Search, Pencil, Trash, Eye, Plus, BarChart, Star, ChevronRight, Trash2Icon } from 'lucide-react';
import Link from 'next/link';
import axiosInstance from '@/utils/axiosInstance';
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import Image from 'next/image';
import DeleteConfirmationModal from '@/shared/modules/auth/components/modals/delete.confirmation.modal';
          ...
          <table className='w-full text-white'>
            ...
            <tbody>
              {table.getRowModel().rows.map((row) => (
                <tr key={row.id} className="borde-b border0gray-800 hove:bg-gray-900 transition">
