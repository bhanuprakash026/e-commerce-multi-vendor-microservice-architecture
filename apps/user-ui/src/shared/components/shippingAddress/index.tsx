    ...
    <div className="space-y-4">
      ...
      <div>
        {isLoading ? (
          ...
          <p className="text-sm text-gray-600">There is no Addresses</p>
        ) : (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center z-50">
          <div className="bg-white w-full max-w-md p-6 rounded-md shadow-md relative">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
              ...
              <select {...register("isDefault")} className="form-input w-full border border-gray-300 rounded-md p-2 text-sm focus:ring focus:ring-blue-200">
...
export default ShippingAddresSection;
